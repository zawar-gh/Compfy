...
export default function RequirementSelection({ onSelect, selectedCategory: propSelectedCategory }: RequirementSelectionProps) {
  ...
  const handleCategorySelect = (categoryId: CategoryType) => {
    ...
    // Auto scroll to intensity selection after a short delay
    setTimeout(() => {
      const intensitySection = document.getElementById('intensity-selection');
      if (intensitySection) {
        intensitySection.scrollIntoView({ 
          behavior: 'smooth', 
          block: 'start',
          inline: 'nearest'
        });
  ...
  const handleIntensitySelect = (intensity: IntensityType) => {
    ...
    // Auto scroll to show the continue button after a short delay
    setTimeout(() => {
            ...
            >
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-300 mb-4">
                    {selectedCategoryData.casual.description}
                  </p>
            ...
            >
              ...
              >
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-300 mb-4">
                    {selectedCategoryData.heavy.description}
                  </p>
                  <ul className="space-y-2">
